...
export ZSH="/home/xploit/.oh-my-zsh"
...
# User configuration
export PATH=/home/xploit/go/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:/usr/share/games:/usr/local/sbin:/usr/sbin:/sbin:~/.local/bin:/snap/bin:$PATH
